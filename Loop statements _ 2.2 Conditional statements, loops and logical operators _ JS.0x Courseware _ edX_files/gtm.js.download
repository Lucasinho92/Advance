...
Y.a.awc=["nonGoogleScripts"],function(){var a=!1;(function(a){Y.__awc=a;Y.__awc.g="awc";Y.__awc.h=!0;Y.__awc.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else{var c=b.vtp_channel||"na",d,e,g;if(b.vtp_group&&0<=b.vtp_group.indexOf(":")){d=b.vtp_group;for(var h=b.vtp_group.split("|"),k=[],l=g=0;l<h.length;l++)if(h[l]){var m=h[l].split(":");if(2==m.length&&m[0]&&m[1]){var p=parseFloat(m[1]);isNaN(p)||(k.push(U(m[0])+":"+p),g+=p)}}e=k.join("|")}else g=b.vtp_orderValue||0,d=(b.vtp_group||"DEFAULT")+":"+
g,e=U(b.vtp_group||"DEFAULT")+":"+U(g);var q=b.vtp_testMode?"1":"0";try{var r=["merchant="+U(b.vtp_merchantId),"ref="+U(b.vtp_orderRef),"amount="+U(g),"parts="+e,"ch="+U(c),"testmode="+q];b.vtp_currency&&r.push("cr="+U(b.vtp_currency));b.vtp_discountCode&&r.push("vc="+U(b.vtp_discountCode));rb("https://www.awin1.com/sread.img?tt=ns&tv=2&"+r.join("&"))}catch(w){}try{var u={};u.orderRef=b.vtp_orderRef;u.amount=g;b.vtp_currency&&(u.currency=b.vtp_currency);u.parts=d;b.vtp_discountCode&&(u.voucher=b.vtp_discountCode);
u.channel=c;u.test=q;B.AWIN={Tracking:{Sale:u}};W("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure);a=!0}catch(w){E(b.vtp_gtmOnFailure)}}})}();
Y.a.awj=["nonGoogleScripts"],function(){var a=!1;(function(a){Y.__awj=a;Y.__awj.g="awj";Y.__awj.h=!0;Y.__awj.b=0})(function(b){if(a)b.vtp_gtmOnSuccess();else try{W("https://www.dwin1.com/"+b.vtp_merchantId+".js",b.vtp_gtmOnSuccess,b.vtp_gtmOnFailure),a=!0}catch(c){E(b.vtp_gtmOnFailure)}})}();
